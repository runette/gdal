...
FUNCTION(DOTNET_DISABLE_NUGET_ORG)
    MESSAGE("-- Disable nuget.org")
    EXECUTE_PROCESS(COMMAND $(DOTNET_EXE) nuget disable nuget.org)
ENDFUNCTION()

FUNCTION(DOTNET_ENABLE_NUGET_ORG)
    MESSAGE("-- Enable nuget.org")
    EXECUTE_PROCESS(COMMAND $(DOTNET_EXE) nuget enable nuget.org)
ENDFUNCTION()
